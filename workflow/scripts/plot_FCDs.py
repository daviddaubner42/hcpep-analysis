...
#     os.remove(os.path.join(args.fcds_path, f"sub-{subid}_windowed_FCs_ses-1_dir-AP.pkl"))
#     os.remove(os.path.join(args.fcds_path, f"sub-{subid}_windowed_FCs_ses-1_dir-PA.pkl"))
#     os.remove(os.path.join(args.fcds_path, f"sub-{subid}_windowed_FCs_ses-2_dir-AP.pkl"))
#     os.remove(os.path.join(args.fcds_path, f"sub-{subid}_windowed_FCs_ses-2_dir-PA.pkl"))
#     os.remove(os.path.join(args.fcds_path, f"sub-{subid}_windowed_FCs_ses-1_mean.pkl"))
#     os.remove(os.path.join(args.fcds_path, f"sub-{subid}_windowed_FCs_ses-2_mean.pkl"))
#     os.remove(os.path.join(args.fcds_path, f"sub-{subid}_windowed_FCs_mean.pkl"))